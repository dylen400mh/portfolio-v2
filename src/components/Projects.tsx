...
const projects = [
  ...
  },
  {
    ...
    description:
      "A full-stack blog application that provides a RESTful API for managing posts and comments, with a frontend for blog management and JWT-based route protection. Included on my portfolio site so viewers can create accounts and leave comments.",
  },
  {
    title: "MyMindfulM8",
