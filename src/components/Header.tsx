...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-transparent text-black sticky top-0 z-10">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className="md:hidden">
          <button onClick={toggleMenu} className="focus:outline-none relative">
            ...
            <div
              className={`w-6 h-0.5 bg-gray-600 mb-1.5 transform transition-transform duration-300 ${
                isOpen ? "rotate-45 translate-y-2" : ""
              }`}
            />
            <div
              className={`w-6 h-0.5 bg-gray-600 mb-1.5 transition-opacity duration-300 ${
      ...
      >
        <nav className="bg-gray-100 border border-gray-400 shadow-lg rounded-lg">
          <ul className="flex flex-col items-center space-y-4 p-4 text-lg">
            <li>
              <button
                ...
                className="hover:bg-gray-300 px-3 py-2 rounded transition-colors duration-300"
              >
                Home
              </button>
            </li>
